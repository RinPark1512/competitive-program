...
public class circleArea {
    public static void main(String[] args) throws IOException {
        ...
        circleArea.FastReader fr = new circleArea.FastReader();
        ...
        double m = 0;
        r = fr.nextDouble();
        // read in input until the radius = 0, meaning we have finished
        while(r != 0){
            m = fr.nextDouble();
            c = fr.nextDouble();
            // find area of the circle
            double a_area = Math.PI * r * r;
            // find the predicted area of the circle using, c/m, the predicted area of the circle according to the square
            // to find circle area, multiply c/m by area of square; square length is 2*(radius of circle)
            double p_area = (c / m) * 4 * r * r;
            pw.println(a_area + " " + p_area);
            //read in the next radius to know if we continue the loop or not
            r = fr.nextDouble();
        }
        // make sure to flush the remaining buffer
        pw.close();
    }
